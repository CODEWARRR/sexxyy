  ...
  const products = [
    {
      ...
      features: ["Ultra-thin 14gsm paper", "Natural Arabic gum", "32 leaves per pack"],
      price: "₹25",
      originalPrice: "₹30",
      badge: "Best Seller",
      rating: 4.8
    },
    {
      ...
      features: ["Unbleached rice paper", "Slow & even burn", "King size 110mm"],
      price: "₹40",
      originalPrice: "₹50",
      badge: "Premium",
      rating: 4.9
    },
    {
      ...
      features: ["Heritage design", "Collector's packaging", "Hand-crafted quality"],
      price: "₹60",
      originalPrice: "₹75",
      badge: "Limited",
      rating: 5.0
  ...
  const comboPacks = [
    {
      ...
      contents: ["2x Jotah Classic", "1x Jotah Premium"],
      originalPrice: "₹90",
      salePrice: "₹75",
      savings: "₹15"
    },
